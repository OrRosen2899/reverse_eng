...
class AIAnalyzer:
    ...
    def format_analysis_prompt(self, analysis_result) -> str:
        ...
        if 'hashes' in analysis_result.features:
            features_summary.append(f"File hashes: {analysis_result.features['hashes']}")
...
### User Message
Analyze this file and explain its behavior:
...
Raw Analysis Data:
{json.dumps(analysis_result.features, indent=2, default=str)[:2000]}

Please provide:
1. A summary of what this file does
2. Assessment of whether it's malicious or benign
3. Specific threats or concerns identified
...
"""
    ...
    def analyze_with_ai(self, analysis_result) -> str:
        ...
        try:
            with self.model_lock:
                prompt = self.format_analysis_prompt(analysis_result)
    ...
    def _get_memory_usage(self) -> Dict[str, str]:
        ...
        return {"memory_info": "unavailable"}
...
class AnalysisEngine:
    ...
    def detect_file_type(self, file_path: Path) -> FileType:
        """Detect file type using magic numbers and extensions"""
        try:
            mime_type = self.magic_detector.from_file(str(file_path))
            extension = file_path.suffix.lower()
            
            # PE executables
            if mime_type.startswith('application/x-executable') or extension in ['.exe', '.dll', '.sys']:
            ...
            # Script files
            if extension in ['.ps1', '.vbs', '.js', '.sh', '.bat', '.cmd']:
    ...
    def analyze_pe_file(self, file_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            # Disassembly analysis with Capstone 
            if sections:
    ...
    def _analyze_code_section(self, pe, code_section) -> Dict[str, Any]:
        """Analyze code section with Capstone disassembler"""
        try:
            ...
            # Analyze first 1000 bytes to avoid excessive processing
            ...
            return {
                ...
                'sample_instructions': instructions[:50],  # First 50 instructions
                'api_calls': api_calls,
            ...
            if vba_parser.detect_vba_macros():
                ...
                for (filename, stream_path, vba_filename, vba_code) in vba_parser.extract_macros():
                    macros.append({
                        ...
                        'code_sample': vba_code[:500],  # First 500 characters
    ...
    def analyze_pdf_file(self, file_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            features['text_sample'] = text_content[:1000]  # First 1000 characters
            
            # Additional PDF analysis would go here
            # (JavaScript extraction, embedded objects, etc.)
    ...
    def analyze_script_file(self, file_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            features['contains_base64'] = 'base64' in content.lower()
            features['contains_powershell'] = 'powershell' in content.lower()
            features['contains_cmd'] = 'cmd' in content.lower()
    ...
    def _assess_threat_level(self, features: Dict[str, Any]) -> ThreatLevel:
        ...
        # Check for macro analysis results
    ...
    def _calculate_confidence(self, features: Dict[str, Any]) -> float:
        ...
        # Increase confidence if we have good feature extraction
...
# Import our modules
from analysis_engine import AnalysisEngine, AnalysisResult, FileType, ThreatLevel
from ai_analyzer import AIAnalyzer
from security_utils import SecurityValidator, QuarantineManager
...
class SecurityAnalyzerGUI(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("Advanced Security Analyzer")
    ...
    def create_menu_bar(self):
        ...
        quarantine_action.triggered.connect(self.open_quarantine_manager)
...
"""
    ...
    def open_quarantine_manager(self):
        """Open quarantine manager dialog"""
        QMessageBox.information(self, "Quarantine Manager", "Quarantine manager not implemented yet.")
...
from PySide6.QtCore import (
    Qt, QThread, QObject, Signal, Slot, QRunnable, QThreadPool,
...
class SecurityValidator:
    def __init__(self, config_manager):
        self.config = config_manager
        self.max_file_size = config_manager.get('max_file_size', 100 * 1024 * 1024)  # 100MB
    ...
    def validate_file(self, file_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            if self._is_suspicious_path(file_path):
                validation_result['warnings'].append("Suspicious file path detected")
    ...
    def _is_suspicious_path(self, file_path: Path) -> bool:
...
class QuarantineManager:
    ...
    def quarantine_file(self, file_path: Path, threat_level: str) -> str:
        ...
        try:
            # Create quarantine subdirectory by threat level
            threat_dir = self.quarantine_dir / threat_level
            threat_dir.mkdir(exist_ok=True)
            
            # Generate unique filename
            file_hash = self._calculate_file_hash(file_path)
            sanitized_name = SecurityValidator(self.config).sanitize_filename(file_path.name)
